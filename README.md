...
## Description
NutriScanAI is a tool for scanning and analyzing nutritional information from food labels using AI.

## Installation
1. Clone the repository:
    ```bash
    git clone https://github.com/imswamya/NutriScanAI.git
    ```
...
[Download NutriScanAI APK](https://drive.google.com/file/d/1WDT1VniKxXDC6N0UQkMF_JMdEYnK-_mx/view?usp=drivesdk)
...
- [Mentor - Suranjeet Kosta](https://github.com/iamkosta)
